...
SECRET_KEY = ')8r!xd$pruiv8-&amp;syx!8i-xtg^vzb95c@ck_x1bhjo_hm+lvb@'
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    "recipesplus.context_processors.add_flagged_recipes_to_context",
)


ROOT_URLCONF = 'recipesplus.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'recipesplus.wsgi.application'
